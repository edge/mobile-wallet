...
//  xe_wallet
//
//  Created by Paul Davis on 01/12/2021.
//
...
public class ProjectContract{
    ...
    init(wallet:Wallet){
        ...
        //if network == .rinkeby{
            endpoint = URL(string:"https://rinkeby.infura.io/v3/f4953edd390547d3bb63dd1f76af13f2")!
            ethContractAddress = EthereumAddress(AppDataModelManager.shared.getNetworkStatus().getDepositTokenAddress(), ignoreChecksum: true)!
            socketURI = "wss://rinkeby.infura.io/ws/v3/f4953edd390547d3bb63dd1f76af13f2"
        //}else{
